    ...
    <div className="p-4 md:p-8 h-full flex flex-col overflow-y-auto">
      ...
      <div className="flex flex-wrap gap-2 mb-6 md:mb-8 p-1 bg-slate-200/50 rounded-xl w-full md:w-fit">
        <button
          ...
          className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-6 py-3 rounded-lg font-bold text-xs md:text-sm transition-all ${
            activeTab === RevenueStream.CAFE ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-200/50'
          }`}
        >
        ...
        <button
          ...
          className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-6 py-3 rounded-lg font-bold text-xs md:text-sm transition-all ${
            activeTab === RevenueStream.SUBSCRIPTION ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-200/50'
          }`}
        >
        ...
        <button
          ...
          className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-6 py-3 rounded-lg font-bold text-xs md:text-sm transition-all ${
            activeTab === RevenueStream.ASSESSMENT ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-200/50'
          }`}
        >
